  ...
  <div className={design.homeContainer}>
    ...
    <div className={design.homeParagraphs}>
      <p className={design.paragraphOne}>
        ...
        but there is no doubt that great mathematicians suffer from maniacal characteristics,
        delirium and symptoms of schizophrenia.
      </p>
      <p className={design.paragraphTwo}>
        Why are numbers beautiful? It is like asking why is Beethoven’s Ninth Symphony beautiful
